...
<!-- ==============products Description========== -->
    ...
    <div class="container margin-top product-section">

        @foreach($products as $index => $product)
        @if($index % 2 == 0)
        <div class="row section border">
            <div class="col-lg-6 sub-section ">
                <div class="yellow-bar sub-section-item">
                    <h2>{{$product->name}}</h2>
                ...
                <div class="sub-section-item">
                @if($index == 0)
                    <a href="/product/{{$product->id}}">www.shengplus.com.tw.flapdisc</a>
                @else
                    <a href="/product/{{$product->id}}">www.shengplus.com.tw.strappingmachine</a>
                @endif
                </div>
            </div>
            <div class="col-lg-6 sub-section-img">
                <img src='{{$product->slug}}.png'>
            </div>
        </div>
        @else
        <div class="row section border">
            ...
            <div class="col-lg-6 sub-section ">
                ...
                <div class="sub-section-item">
                    @if($index == 1)
                        <a href="/product/{{$product->id}}">www.shengplus.com.tw.weldingmachine</a>
                    @else
                        <a href="/product/{{$product->id}}">www.shengplus.com.tw.preciousmetal</a>
                    @endif
                </div>
            </div>
        </div>
